...
import com.apparchar.apparcompany.Contract.ContractEmpresa;
import com.apparchar.apparcompany.Presentador.EmpresaPresenter;
...
public class Empresa extends AppCompatActivity implements ContractEmpresa.ViewE {
    ...
    @Override
    public void cambiar() {
        Intent cargar = new Intent(this, LoginCompany.class);
