package com.apparchar.apparcompany.Conexion;
...
public class MyLoopjTask {
   ...
   String MYURL="http:http://ec2-52-201-217-138.compute-1.amazonaws.com:8080/ServerApparchar-1.0-SNAPSHOT/"; //glasfish4
